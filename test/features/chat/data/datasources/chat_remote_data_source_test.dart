...
void main() {
  ...
  group('sendMessage', () {
    test('should complete successfully when the call is successful', () async {
      ...
      await firestore
          .collection('groups')
          .doc(message.groupId)
          .set(const GroupModel.empty().copyWith(id: message.groupId).toMap());
  ...
  group('getMessages', () {
    test('should return a stream of messages when the call is successful',
      ...
      await firestore
          .collection('groups')
          .doc(groupId)
          .set(const GroupModel.empty().copyWith(id: groupId).toMap());
  ...
  group('getGroups', () {
    test('should return a stream of groups when the call is successful', () {
      ...
      final expectedGroups = [
        const GroupModel.empty().copyWith(
          id: '1',
          activityId: '1',
          name: 'Group 1',
        ),
  ...
  group('getUserById', () {
    test('should return a user when the call is successful', () async {
      ...
      final expectedUser = LocalUserModel.empty().copyWith(uid: userId);
