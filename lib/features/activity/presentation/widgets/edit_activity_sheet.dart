...
class EditActivitySheet extends StatefulWidget {
  ...
  const EditActivitySheet({Key? key, required this.editActivity})
      : super(key: key);
...
class _EditActivitySheetState extends State<EditActivitySheet> {
  ...
  void initState() {
    ...
    // Wypełnij pola danymi edytowanej aktywności
    final editActivity = widget.editActivity;
    titleController.text = editActivity.title;
    descriptionController.text = editActivity.description;
    imageController.text = editActivity.image!;
    // Wypełnij pozostałe pola w ten sam sposób
  }
  ...
  Widget build(BuildContext context) {
    selectedLocation =
        LatLng(widget.editActivity.latitude, widget.editActivity.longitude);
    return BlocListener<ActivityCubit, ActivityState>(
      listener: (_, state) {
        if (state is ActivityError) {
          CoreUtils.showSnackBar(context, state.message);
        } else if (state is UpdatingActivity) {
          loading = true;
            ...
            child: ListView(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: IField(
                        ...
                        labelText: 'Location',
                        hintText: widget.editActivity.location,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'This field is required';
                          }
                ...
                TextFieldTags(
                  ...
                  initialTags: widget.editActivity.tags,
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (formKey.currentState!.validate()) {
                            ...
                            // Konwersja Activity na ActivityModel
                            final existingActivityModel =
                                widget.editActivity as ActivityModel;

                            final updatedActivityModel =
                                existingActivityModel.copyWith(
                            ...
                            context
                                .read<ActivityCubit>()
                                .updateActivity(updatedActivityModel);
                          }
                        },
